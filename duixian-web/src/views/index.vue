<template>
    <div>
        <div class="home">
            ...
            <div class="mp4">
                <el-carousel :interval="5000" type="card" height="450px" indicator-position="outside">
                    <el-carousel-item @click="playVideo('http://cdn.qubit-dance.com/v/1.mp4')">
                        <img src="@/assets/home/mv1.png"/>
                    </el-carousel-item>
                    <el-carousel-item @click="playVideo('http://cdn.qubit-dance.com/v/2.mp4')">
                        <img src="@/assets/home/mv2.png"/>
                    </el-carousel-item>
                    <el-carousel-item @click="playVideo('http://cdn.qubit-dance.com/v/3.mp4')">
                        <img src="@/assets/home/mv3.png"/>
                    </el-carousel-item>
                </el-carousel>
            </div>
            <div class="about">
                <div class="left">
                    ...
                    <div class="time">
                        <img src="@/assets/home/icon-tel.png" />
                    ...
                    <div class="tel">
                        <img src="@/assets/home/icon-qq.png" />
            ...
            <div class="faq">
                <div class="faq-item" v-for="faqItem in faqData" :key="faqItem">
                    <div class="faq-content">
                        ...
                        <div class="img-faq"><img src="@/assets/home/faq.png" /></div>
        ...
        <div class="float-page">
            ...
            >
                <div class="float-ewm">
                    <img src="@/assets/home/float-ewm.png" />
                    <div class="ewm-text">扫码关注微信公众号</div>
                </div>
                <template #reference>
...
<script setup>
// import mv1 from '@/assets/mv1.mp4'
// import mv2 from '@/assets/mv2.mp4'
// import mv3 from '@/assets/mv3.mp4'
...
const isVideoVisible = ref(false); // 控制视频弹窗的显示/隐藏
const currentVideo = ref(''); // 当前视频的路径
const videoPlayer = ref(null); // 视频播放器的引用

const playVideo = (videoSrc) => {
    currentVideo.value = videoSrc; // 动态加载视频
    isVideoVisible.value = true; // 显示视频弹窗
};

const stopVideo = () => {
    if (videoPlayer.value) {
    videoPlayer.value.pause(); // 停止视频播放
    }
};
const handleClose = () => {
      stopVideo(); // 停止播放视频
      isVideoVisible.value = false; // 关闭弹窗
    };
</script>
